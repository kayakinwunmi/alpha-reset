      ...
      <section className="py-16 md:py-24 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-[var(--ink)] mb-2">
            The next one starts{" "}
            <span className="font-semibold text-[var(--accent)]">8 April 2026</span>.
          </p>

          <div className="my-12">
            <Countdown targetDate="2026-04-08T00:00:00Z" />
          </div>
      ...
      <section id="signup" className="py-20 px-6 bg-[var(--paper-dark)]">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-lg text-[var(--ink-light)] mb-3">
            Next session: <span className="font-semibold text-[var(--accent)]">8–10 April 2026</span>
          </p>
