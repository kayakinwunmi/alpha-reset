  ...
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background-color:#141414;border:1px solid #222;border-radius:12px;padding:32px 24px;margin-bottom:24px;">
      ...
      <p style="font-size:16px;line-height:1.6;color:#ccc;margin:0 0 24px;">
        The next <strong style="color:#D4AF37;">Alpha Reset</strong> begins <strong style="color:#fff;">24 June 2026</strong> — a 72-hour water fast + deep life review that will transform how you think, move, and lead.
      </p>
